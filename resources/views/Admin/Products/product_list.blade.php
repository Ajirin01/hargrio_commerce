                  ...
                  <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                          {{$product->stock}}
                          @if(($product->stock) < 5)
                            <span class="badge badge-danger">{{$product->stock < 5 ? 'Low Stock' : 'Available'}}</span>
                          @endif
                        </td>
                        <td><span class="badge badge-{{$product->available ? 'success' : 'danger'}}">{{$product->available ? 'Available' : 'Not Available'}}</span></td>
                        <td>
