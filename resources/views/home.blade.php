...
@section('content')
    ...
    <section class="hero-v2 position-relative d-flex align-items-center overflow-hidden" style="min-height: 95vh;">
        ...
        <img src="{{ asset('site/images/hero-grains-bokeh.png') }}" alt="Organic ancient grains in warm sunlight"
            class="hero-v2__bg-img" style="position:absolute;inset:0;width:100%;height:100%;object-fit:cover;z-index:0;">
        ...
        <div class="container position-relative" style="z-index:3;">
            <div class="row align-items-center g-5">
                ...
                <div class="col-lg-7">
                    ...
                    <div class="hero-v2__trust-bar d-inline-flex align-items-center gap-2 mb-5" style="
                        ...
                        <div class="d-flex align-items-center gap-1 me-1">
                            <span
                                style="width:26px;height:26px;border-radius:50%;background:#9EBA9B;display:inline-flex;align-items:center;justify-content:center;">
                            ...
                            <span
                                style="width:26px;height:26px;border-radius:50%;background:#F2E6D8;display:inline-flex;align-items:center;justify-content:center;">
                                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#5C4742"
                                    stroke-width="2.5">
                                    <path d="M12 22s8-4 8-10V5l-8-3-8 3v7c0 6 8 10 8 10z" />
                                </svg>
                            </span>
                            <span
                                style="width:26px;height:26px;border-radius:50%;background:#5C4742;display:inline-flex;align-items:center;justify-content:center;">
                                <svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#F2E6D8"
                                    stroke-width="2.5">
                                    <path
                        ...
                        <span
                            style="font-size:0.72rem;font-weight:700;letter-spacing:1.5px;text-transform:uppercase;color:#fff;opacity:0.92;">
                            10,000+ Families TO BE Nourished Naturally
                        </span>
                    </div>

                    {{-- ── Primary Headline (step 2 of Z – bold, high contrast) ── --}}
                    <h1 class="hero-v2__headline text-white text-uppercase mb-0" style="
                    ...
                    <h2 class="hero-v2__sub-headline mb-5" style="
                            font-family:'Montserrat',sans-serif;
                    ...
                    <div style="animation: heroFadeUp 0.7s 0.42s ease both;">
                        <a href="{{ route('shop.index') }}"
                            class="hero-v2__cta d-inline-flex align-items-center gap-2 fw-bold rounded-pill" style="
                               background:#5C4742;
                               color:#fff;
                               padding:15px 36px;
                               font-family:'Montserrat',sans-serif;
                ...
                <div class="col-lg-5 d-flex justify-content-end">
                    ...
                    <div class="hero-v2__glass" style="
                        ...
                        <div class="mb-3 d-flex align-items-center gap-2">
                            <span
                                style="display:inline-block;width:28px;height:2px;background:#9EBA9B;border-radius:2px;"></span>
                            <span
                                style="font-size:0.7rem;font-weight:700;letter-spacing:2px;text-transform:uppercase;color:#9EBA9B;">AT
                                HARGRIO</span>
                        </div>

                        <p
                            style="font-family:'Montserrat',sans-serif;font-size:1.05rem;line-height:1.85;font-weight:300;color:rgba(255,255,255,0.95);margin:0 0 1.5rem;">
                            We create nutritious grain blends inspired by Africa’s rich food heritage and adapted for
                            today’s fast-paced lifestyles. Our products combine carefully selected ancient grains to deliver
                            authentic taste, balanced nutrition, and convenience for modern kitchens.
                        </p>

                        <p
                            style="font-family:'Montserrat',sans-serif;font-size:0.95rem;line-height:1.75;font-weight:300;color:rgba(242,230,216,0.75);margin:0;">
                            Each blend is thoughtfully prepared to preserve natural nutrients, rich flavour, and the
                            tradition of wholesome grain foods that have nourished communities for generations.
                        </p>
                        ...
                        <div class="mt-4 pt-4 d-flex gap-4" style="border-top:1px solid rgba(255,255,255,0.12);">
                            <div class="text-center">
                                <div
                                    style="font-family:'Montserrat',sans-serif;font-size:1.6rem;font-weight:800;color:#F2E6D8;line-height:1;">
                                    10000+</div>
                                <div
                                    style="font-size:0.65rem;letter-spacing:1.5px;text-transform:uppercase;color:rgba(255,255,255,0.55);margin-top:3px;">
                                    years of Heritage</div>
                            </div>
        ...
        {{-- ─── Scroll hint arrow ─── --}}
        <div
            style="position:absolute;bottom:2rem;left:50%;transform:translateX(-50%);z-index:3;opacity:0.6;animation:scrollBounce 2s infinite;">
            ...
            <div class="row align-items-center">
                ...
                <div class="col-lg-5 mb-5 mb-lg-0 scroll-reveal">
                    <div class="position-relative">
                        <style>
                            .story-img { width: 100%; object-fit: cover; height: 1000px; }
                            @media (max-width: 991.98px) { .story-img { height: 600px; } }
                        </style>
                        <img src="{{ asset('site/images/our-story.png') }}" alt="Traditional Milling"
                            class="img-fluid rounded-lg shadow-lg story-img">
                    </div>
                </div>

                {{-- Right Column: Story Text --}}
                <div class="col-lg-7 scroll-reveal" style="--reveal-delay: 200ms">
                    <h5 class="text-uppercase mb-3" style="color: var(--brand-secondary); letter-spacing: 3px; font-size: 0.8rem; font-weight: 700;">Nourishing the Future with Africa’s Ancient Grains</h5>
                    ...
                    <div class="story-content mb-5" style="font-size: 1.1rem; color: #555; line-height: 1.8;">
                        <p class="mb-4">
                            Hargrio was founded with a bold vision — to bring the nutritional richness of Africa’s ancient grains to modern consumers around the world.
                        </p>
                        <p class="mb-4">
                            For generations, grains such as teff, millet, oat, and cassava have been at the heart of African diets, valued for their nourishment, resilience, and natural goodness. Yet, in today’s fast-paced world, many people struggle to access these traditional foods in convenient and modern formats.
                        </p>
                        <p class="mb-4">
                            <strong>Hargrio was created to bridge that gap.</strong>
                        </p>
                        <p class="mb-4">
                            By combining traditional knowledge with modern food innovation, we develop nutrient-dense grain blends that make authentic African staples easier to prepare, healthier to enjoy, and accessible to a global audience.
                        </p>
                        <p class="mb-4">
                            Our carefully crafted blends — including products like Milla, MOAT, and NutriCore — are made using high-quality grains selected for their nutritional value, taste, and heritage. Each product reflects our commitment to wholesome ingredients, cultural authenticity, and sustainable food systems.
                        </p>
                        <p class="mb-4">
                            Today, Hargrio is more than a food brand. It is part of a growing movement to celebrate African grains, promote healthier eating, and share Africa’s rich food heritage with the world.
                        </p>
                        <p class="fst-italic" style="color: var(--brand-secondary); font-weight: 500;">
            ...
            <div class="row text-center scroll-reveal">
                <div class="col-12" style="max-width: 800px; margin: 0 auto;">
                    ...
                    <h2 class="display-4 fw-bold mb-4" style="color: #0b1528; line-height: 1.1; font-family: var(--font-family-sans-alt);">
                        The Hargrio Brand Ecosystem
                    </h2>
                    <p class="text-muted" style="font-size: 1.1rem; line-height: 1.7; color: #5c6270 !important;">
                        Hargrio is built as a growing network of food brands focused on innovation, nutrition, and the celebration of African grains and culinary traditions. Each brand collection serves a unique purpose within the Hargrio ecosystem, allowing us to develop products that meet the needs of modern consumers while honouring Africa’s rich food heritage.
                        <br><br>
                        Together, these collections form the foundation of Hargrio’s mission to transform traditional ingredients into modern food solutions for households, chefs, and global markets.
                    </p>
                </div>
            </div>

            <div class="row justify-content-center mt-5">
                <!-- Brand 1: Hargrio Foods -->
                <div class="col-12 col-md-4 col-lg-4 mb-5 scroll-reveal" style="--reveal-delay: 0ms">
                    <div class="product-item rounded p-4 h-100 d-flex flex-column align-items-center position-relative" style="background: var(--brand-light); border: 1px solid #eaeaea;">
                        <div class="mb-4 d-flex align-items-center justify-content-center" style="height: 180px; width: 100%;">
                            <img src="{{ asset('site/images/hargrio_food_brand.png') }}" class="img-fluid shadow-sm" style="max-height: 180px; max-width: 100%; border-radius: 20px; object-fit: contain; width: 100%;" alt="Hargrio Foods Logo">
                        </div>
                ...
                <!-- Brand 2: Hargrio Cooking Signature -->
                <div class="col-12 col-md-4 col-lg-4 mb-5 scroll-reveal" style="--reveal-delay: 100ms">
                    <div class="product-item rounded p-4 h-100 d-flex flex-column align-items-center position-relative" style="background: var(--brand-light); border: 1px solid #eaeaea;">
                        <div class="mb-4 d-flex align-items-center justify-content-center" style="height: 180px; width: 100%;">
                            <img src="{{ asset('site/images/hargrio_cooking_signature_brand.png') }}" class="img-fluid shadow-sm" style="max-height: 180px; max-width: 100%; border-radius: 20px; object-fit: contain; width: 100%;" alt="Hargrio Cooking Signature Logo">
                        </div>
                        <h3 class="product-title font-serif text-center mb-3">Hargrio Cooking Signature</h3>
                        <p class="text-muted small text-center px-2 mb-4 flex-grow-1">Culinary excellence designed for chefs and professionals.</p>
                        <div class="mt-auto w-100 text-center position-relative" style="z-index: 11;">
                            <button class="btn btn-secondary btn-sm rounded-pill px-4" disabled style="opacity: 0.8; cursor: not-allowed;"><i class="fas fa-lock me-1"></i> Learn More</button>
                        </div>
                    </div>
                </div>

                <!-- Brand 3: Hargrio More -->
                <div class="col-12 col-md-4 col-lg-4 mb-5 scroll-reveal" style="--reveal-delay: 200ms">
                    <div class="product-item rounded p-4 h-100 d-flex flex-column align-items-center position-relative" style="background: var(--brand-light); border: 1px solid #eaeaea;">
                        <div class="mb-4 d-flex align-items-center justify-content-center" style="height: 180px; width: 100%;">
                            <img src="{{ asset('site/images/hargrio_more_brand.png') }}" class="img-fluid shadow-sm" style="max-height: 180px; max-width: 100%; border-radius: 20px; object-fit: contain; width: 100%;" alt="Hargrio More Logo">
                        </div>
                        <h3 class="product-title font-serif text-center mb-3">Hargrio More</h3>
                        <p class="text-muted small text-center px-2 mb-4 flex-grow-1">Expanding our heritage into exciting new nutritional frontiers.</p>
                        <div class="mt-auto w-100 text-center position-relative" style="z-index: 11;">
                            <button class="btn btn-secondary btn-sm rounded-pill px-4" disabled style="opacity: 0.8; cursor: not-allowed;"><i class="fas fa-lock me-1"></i> Learn More</button>
                        </div>
                    </div>
            ...
            <div class="container">
                ...
                <div class="text-center mb-5 scroll-reveal">
                    ...
                    <p class="faq-subtitle mx-auto text-muted" style="max-width: 600px; font-size: 1.1rem; line-height: 1.8;">
                        Everything you need to know about our brand collection, ordering, and preparation.
                    </p>
                </div>
