				...
				<div class="row justify-content-between">
					<div class="col-lg-5">
						<div class="intro-excerpt">
							<h1>Contact Hargrio</h1>
							<p class="mb-4">
								Get in touch with Hargrio Limited for product enquiries,
								wholesale partnerships, retail supply or general information.
								We welcome enquiries from households, retailers, catering
								businesses and distribution partners across the UK.
							</p>
							<p>
								<a href="{{ route('shop.index') }}" class="btn btn-secondary me-2">Shop Products</a>
								<a href="javascript:void(0)" data-bs-toggle="modal" data-bs-target="#wholesaleModal" class="btn btn-white-outline">Wholesale Enquiries</a>
							</p>
						</div>
					</div>
					<div class="col-lg-7">
						<div class="hero-img-wrap">
							<img src="{{ asset('site/images/hargrio_hero.png') }}" class="img-fluid" alt="Contact Hargrio Limited">
						</div>
					</div>
				</div>
			</div>
